...
import com.flow.api.response.ItemGroupsForUserResponse;
import com.flow.api.response.TopNewsResponse;
import com.flow.engine.FlowEngine;
import com.flow.commons.AsyncService;
...
//    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    ...
    public Response addItem(@Context HttpServletRequest request,
        ...
        com.flow.engine.model.Item.Builder builder = new com.flow.engine.model.Item.Builder();
        ...
        final com.flow.engine.model.Item item = builder.build();
